...
- [x] Describe Middleware?
        ...
        Middleware provides a way to extend Express features. Middle ware is an array of functions that get excuted in the order they are introduced into the server code.

- [x] Describe a Resource?

        A resource is data requested from the API that is on the server.

- [x] What can the API return to help clients know if a request was successful?

        An API can return a status code that is in reqponse if the request was successful or not (200, 201)

- [x] How can we partition our application into sub-applications?

        Routing can be used to manage the requests.
